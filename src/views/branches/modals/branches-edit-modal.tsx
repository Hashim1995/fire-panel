...
function BranchesEditModal({
  ...
  const {
    ...
    defaultValues: {
      ...
      terminalGroup:
        selectedItem?.terminalGroups?.find(
          (z: ITerminalGroupItem) => z?.isMain
        ) ?? null,
      openingHour: selectedItem?.openingHour
        ? {
            value: selectedItem?.openingHour?.toString(),
            label: selectedItem?.openingHour?.toString()
          }
        : null,
      closingHour: selectedItem?.closingHour
        ? {
            value: selectedItem?.closingHour?.toString(),
            label: selectedItem?.closingHour?.toString()
          }
        : null
    }
  });
  ...
  const onSubmit: SubmitHandler<IBranchItemPayload> = async (
    ...
    if (
      data?.closingHour &&
      typeof data?.closingHour === 'object' &&
      'value' in data?.closingHour
    ) {
      formData.append('closingHour', data?.closingHour?.value.toString());
    }
    if (
      data?.openingHour &&
      typeof data?.openingHour === 'object' &&
      'value' in data?.openingHour
    ) {
    ...
    formData.append(
      'terminalGroup',
      data?.terminalGroup?.value ? data?.terminalGroup?.value : ''
    );
                  ...
                  render={({ field: { onChange, value } }) => (
                    ...
                    >
                      ...
                      <Tooltip
                        ...
                        placement="top-end"
                        label={
                          errors.terminalGroup
                            ? errors.terminalGroup.message
                            : ''
                        }
                      >
                        <div>
